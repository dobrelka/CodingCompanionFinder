...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.raywenderlich.codingcompanionfinder.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.raywenderlich.codingcompanionfinder.GlideOptions().apply(toSet));
    }
  }
}
